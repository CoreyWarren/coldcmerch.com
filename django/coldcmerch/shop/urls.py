...
from .views import RetrieveProductView, RetrieveOrderView, RetrieveCartView, RetrieveCartItemView, CreateOrderView, CreateCartView, CreateCartItemView
...
urlpatterns = [
    ...
    # PRODUCTS:
    # api/shop/product
    path('product', RetrieveProductView.as_view()),
